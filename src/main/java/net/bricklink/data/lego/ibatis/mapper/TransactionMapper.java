...
public interface TransactionMapper {
    ...
    @Insert("""
            INSERT INTO transaction_item (item_id, transaction_id, transaction_type_code, price, notes, box_condition_id, instructions_condition_id) \
    ...
    @Select("""
            SELECT transaction_id, transaction_date, notes, shipping_amount, from_party_id, to_party_id \
            FROM transactions \
